/*
 *  MQTT example vor the Vista20SE sketch (esp8266/esp32)
 *
...
const int maxZones=38;

const int keypadAddr1=31;
...
const char * rfSerialLookup=  "001234:66:80,081234:22:80,0123456:55:80"; //#serial1:zone1:mask1,#serial2:zone2:mask2
